...
class BansControllerTest < ActionController::TestCase
  ...
  test "should create ban" do
    assert_difference('Ban.count') do
      post :create, ban: { hooligan_id: @ban.hooligan_id, number_of_years: @ban.number_of_years, stadium_id: @ban.stadium_id }
    end
  ...
  test "should update ban" do
    patch :update, id: @ban, ban: { hooligan_id: @ban.hooligan_id, number_of_years: @ban.number_of_years, stadium_id: @ban.stadium_id }
    assert_redirected_to ban_path(assigns(:ban))
  end
