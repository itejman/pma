...
class CoachesControllerTest < ActionController::TestCase
  ...
  test "should create coach" do
    assert_difference('Coach.count') do
      post :create, coach: { age: @coach.age, first_name: @coach.first_name, last_name: @coach.last_name }
    end
  ...
  test "should update coach" do
    patch :update, id: @coach, coach: { age: @coach.age, first_name: @coach.first_name, last_name: @coach.last_name }
    assert_redirected_to coach_path(assigns(:coach))
  end
